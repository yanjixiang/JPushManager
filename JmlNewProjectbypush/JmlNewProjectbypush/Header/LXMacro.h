...
//导航栏的高度
#define HitoNavBarHeight  self.navigationController.navigationBar.frame.size.heigh
...
//导航栏字体颜色
#define FONTANDCOLOR [[UINavigationBar appearance] setTintColor:[UIColor whiteColor]];[self.navigationController.navigationBar setTitleTextAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:18],NSForegroundColorAttributeName:[UIColor whiteColor]}];
